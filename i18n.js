(function () {
  ...
  "bs": {
    ...
    "hero.title": "Putni nalozi, radni nalozi<br>i upravljanje imovinom<br><span class=\"font-display italic text-primary\">u jednom sistemu.</span>",
    "hero.subtitle": "APN je operativna platforma za kompanije u Bosni i Hercegovini i\n                  regiji koje upravljaju ljudima, vozilima i opremom. Objedinjuje\n                  digitalne putne naloge, radne naloge, upravljanje imovinom i\n                  upravljanje voznim parkom u jednu internu platformu — bez papira,\n                  bez razbacanih Excel tabela.",
    "hero.cta_secondary": "Obilazak platforme",
    "trust.security": "Poslovna sigurnost",
    ...
    "industries.automotive": "Automobilska industrija",
    ...
    "moduli.subtitle": "Fokusirana interna platforma: putni nalozi, radni nalozi,\n                upravljanje imovinom, korisnici i izvještaji — bez nepotrebnih modula.",
    ...
    "modules.card3.title": "Upravljanje imovinom",
    "modules.card3.desc": "Prilagodljivi registar imovine — vozila, laptopi, alati, oprema.\n                  Ovaj sistem za upravljanje imovinom pokriva svaku klasu imovine i\n                  olakšava upravljanje imovinom u cijeloj kompaniji.",
    "modules.card4.title": "Upravljanje voznim parkom",
    "modules.card4.desc": "Specijalizovani modul za kompanije koje koriste službena\n                  vozila — nadograđen na upravljanje imovinom: registracija,\n                  servisi, osiguranje, kilometraža i historija iz jednog\n                  registra. Kao sistem za vozni park, pokriva potpuno\n                  upravljanje voznim parkom na jednom mjestu.",
    "modules.card5.title": "Upravljanje korisnicima",
    "modules.card5.desc": "Uposlenici, uloge i pristupi. Svaki korisnik vidi tačno ono\n                  što treba — upravljanje korisnicima i ulogama uz detaljne\n                  dozvole i potpune zapise aktivnosti.",
    ...
    "timeline.subtitle": "Svaka radnja automatski ažurira historiju uposlenika i imovine.\n                Bez preklapanja, bez dupliranja, bez zaboravljanja.",
    ...
    "automation.card5.desc": "Automatski planovi za svaku klasu imovine.",
    "automation.card6.title": "Tokovi odobravanja",
    "automation.card6.desc": "Digitalni tok rada do potpisa i arhive.",
    "automation.card7.title": "Dodjela imovine",
    ...
    "automation.card9.title": "Obavještenja radnih naloga",
    ...
    "security.card1.title": "Dozvole po ulogama",
    "security.card1.desc": "Detaljne dozvole po timovima i lokacijama.",
    "security.card2.title": "Zapisi aktivnosti",
    "security.card2.desc": "Svaka akcija zabilježena i pretraživa.",
    "security.card3.title": "Cloud infrastruktura",
    "security.card3.desc": "Redundantna, geografski distribuirana.",
    ...
    "security.card6.title": "Podrška za više kompanija",
    ...
    "mobileapp.feat1": "Pretraga imovine",
    ...
    "mobileapp.feat7": "Push obavještenja",
    "mobileapp.feat8": "Režim bez veze",
    ...
    "cta.trust2": "Poslovni SLA",
    "cta.trust3": "Posvećen tim za implementaciju",
    ...
    "footer.link_asset_management": "Upravljanje imovinom",
    "footer.link_fleet_management": "Upravljanje voznim parkom",
    "footer.link_user_management": "Upravljanje korisnicima",
    "footer.link_izvjestaji": "Izvještaji",
    "footer.link_cijene": "Cijene",
    "footer.link_sigurnost_compliance": "Sigurnost i usklađenost",
    "faq.badge": "Česta pitanja",
    "faq.title": "Česta pitanja",
    "faq.subtitle": "Odgovori na najčešća pitanja o putnim i radnim nalozima,\n                upravljanju imovinom, voznom parku i sigurnosti u APN-u.",
  ...
  "en": {
    ...
    "modules.card3.title": "Asset Management",
    ...
    "modules.card4.title": "Fleet Management",
    ...
    "modules.card5.title": "User Management",
  ...
  "de": {
    ...
    "hero.title": "Reiseaufträge, Arbeitsaufträge<br>und Anlagenverwaltung<br><span class=\"font-display italic text-primary\">in einem System.</span>",
    "hero.subtitle": "APN ist eine Betriebsplattform für Unternehmen in Bosnien und Herzegowina und der Region, die Mitarbeiter, Fahrzeuge und Ausrüstung verwalten. Sie vereint digitale Reiseaufträge, Arbeitsaufträge, Anlagenverwaltung und Fuhrparkverwaltung in einer internen Plattform — ohne Papier, ohne verstreute Excel-Tabellen.",
    ...
    "modules.card3.title": "Anlagenverwaltung",
    "modules.card3.desc": "Ein anpassbares Anlagenregister — Fahrzeuge, Laptops, Werkzeuge, Ausrüstung. Dieses Anlagenverwaltungssystem deckt jede Anlagenklasse ab und vereinfacht das Anlagenmanagement im gesamten Unternehmen.",
    "modules.card4.title": "Fuhrparkverwaltung",
    "modules.card4.desc": "Ein spezialisiertes Modul für Unternehmen mit Firmenfahrzeugen — aufbauend auf der Anlagenverwaltung: Zulassung, Service, Versicherung, Kilometerstand und Historie aus einem Register. Als Fuhrparkverwaltungssystem deckt es die komplette Fuhrparkverwaltung an einem Ort ab.",
    "modules.card5.title": "Benutzerverwaltung",
    "modules.card5.desc": "Mitarbeiter, Rollen und Zugriffsrechte. Jeder Benutzer sieht genau das, was er braucht — Benutzer- und Rollenverwaltung mit granularen Berechtigungen und vollständigen Aktivitätsprotokollen.",
    ...
    "footer.link_automotive": "Automobilindustrie",
    "footer.link_mobilnost": "Mobilität",
    "footer.link_servis": "Service",
    "footer.link_enterprise": "Für Unternehmen",
    ...
    "footer.link_asset_management": "Anlagenverwaltung",
    "footer.link_fleet_management": "Fuhrparkverwaltung",
    "footer.link_user_management": "Benutzerverwaltung",
    "footer.link_izvjestaji": "Berichte",
    "footer.link_cijene": "Preise",
    "footer.link_sigurnost_compliance": "Sicherheit & Compliance",
    "faq.badge": "FAQ",
    "faq.title": "Häufige Fragen",
    "faq.subtitle": "Antworten auf die häufigsten Fragen zu Reiseaufträgen, Arbeitsaufträgen, Anlagenverwaltung, Fuhrparkverwaltung und Sicherheit in APN.",
    ...
    "faq.q3.question": "Wie unterstützt APN die Fuhrparkverwaltung?",
    "faq.q3.answer": "Das Fuhrparkverwaltungsmodul baut auf der Anlagenverwaltung auf und verfolgt Zulassung, Versicherung, Service, Kilometerstand und Fahrerzuweisung. Erinnerungen warnen Wochen im Voraus vor Ablauf von Zulassung oder Service, sodass die Fuhrparkverwaltung proaktiv statt reaktiv wird.",
    "faq.q4.question": "Kann APN für die Anlagenverwaltung des gesamten Unternehmens genutzt werden?",
    "faq.q4.answer": "Ja. APN ist ein anpassbares Anlagenverwaltungssystem, das Fahrzeuge, IT-Ausrüstung, Werkzeuge, Möbel und Industrieausrüstung in einem Register abdeckt — mit Klassen, Abschreibung und Garantien pro Anlageneinheit, nicht nur für den Fuhrpark.",
    "faq.q5.question": "Unterstützt APN unterschiedliche Rollen und Berechtigungen?",
    "faq.q5.answer": "Ja. Das Benutzerverwaltungsmodul ermöglicht granulare Berechtigungen nach Team, Standort und Abteilung, mit einem vollständigen Aktivitätsprotokoll jeder Aktion. Die Unterstützung mehrerer Unternehmen trennt zusätzlich Zugriff und Daten zwischen mehreren Unternehmen im selben System.",
    "faq.q6.question": "Wie lange dauert die Implementierung von APN?",
    "faq.q6.answer": "Die Implementierung dauert Tage, nicht Monate — die Einrichtung der Kernmodule (Reiseaufträge, Arbeitsaufträge, Anlagenregister) ist in der Regel innerhalb der ersten Woche einsatzbereit, mit einem engagierten Team für die Einführung."
  }
};

  var META = {
  "bs": {
    "title": "APN — Putni i radni nalozi, upravljanje imovinom i voznim parkom",
    "description": "APN je platforma za putne naloge, radne naloge, upravljanje imovinom i upravljanje voznim parkom — za kompanije u BiH i regiji koje upravljaju ljudima i imovinom."
  },
  "en": {
  ...
  "de": {
    "title": "APN — Reise- & Arbeitsaufträge, Anlagen- und Fuhrparkverwaltung",
    "description": "APN ist eine Plattform für Reiseaufträge, Arbeitsaufträge, Anlagenverwaltung und Fuhrparkverwaltung — für Unternehmen in Bosnien-Herzegowina und der Region."
  }
};
